			...
			<div className="jumbotron">
				<div className="row flex">
					<div className="col-lg-4 col-sm-6">
						<div>
							<h3>
								<i className="fa fa-bolt fa-2x" /> Super Fast
							</h3>
							<p>
					...
					<div className="col-lg-4 col-sm-6">
						<div>
							<h3>
								<i className="fa fa-shield fa-2x" /> Flexible Encryption
							</h3>
							<p>
					...
					<div className="col-lg-4 col-sm-6">
						<div className="">
							<h3>
								<i className="fa fa-mobile fa-2x" /> Mobile Ready
							</h3>
							<p>
					...
					<div className="col-lg-4 col-sm-6">
						<div className="">
							<h3>
								<i className="fa fa-arrows-alt fa-2x" /> Cross Platform
							</h3>
							<p>
					...
					<div className="col-lg-4 col-sm-6">
						<div className="">
							<h3>
								<i className="fa fa-group fa-2x" /> Open Source
							</h3>
							<p>
					...
					<div className="col-lg-4 col-sm-6">
						<div className="">
							<h3>
								<i className="fa fa-cloud fa-2x" /> Easy Deployment
							</h3>
							<p />
							<p>
